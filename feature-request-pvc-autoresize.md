---
name: "Feature: Automatic PVC Resizing with WAL-Aware Safety"
about: Proposal for native PVC auto-resize support in CloudNativePG
title: "[Feature]: Automatic PVC Resizing with WAL-Aware Safety Checks"
labels: enhancement
---
...
| #8369 | Increase storage above EBS size limit, unrecoverable state | Closed | maxSize validation needed |
...
A comprehensive RFC with detailed design, API types, implementation code, and E2E testing strategy is available as a **GitHub Discussion** for community review. See the companion discussion post.
